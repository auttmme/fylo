...
export default function EarlyAccessCard() {
  ...
  const validateEmail = (e) => {
	...
	return (
    <div className='text-white bg-intro-blue p-9 w-1/2 mx-auto shadow-2xl rounded-md'>
      <h2 className='font-raleway text-3xl font-bold tracking-wide text-center'>Get early access today</h2>
      <p className='text-center my-7 w-1/2 mx-auto'>It only takes a minute to sign up and our free starter tier is extremely generous. If you have any questions, our support team would be happy to help you</p>
      ...
      {(isValid == false && email !== '') && (
        <p className='text-red-500 mt-2 ml-44'>{message}</p>
      )}
    </div>
  )
}
